# CM4 MANET — compacte ongerouteerde PCB v0.7

Lees COMPACT-LEESMIJ.md: dit is de actieve 76 x 56 mm variant. De tekst hieronder is historisch.

Lees BEKIJK-EERST.md voor de actuele PCB-plaatsing, controles en beperkingen. De onderstaande tekst is historische schemadocumentatie. Routing wacht op gebruikersgoedkeuring.
