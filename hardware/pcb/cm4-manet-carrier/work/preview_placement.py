...
for idx,side in enumerate(["F","B"]):
    ...
    d.text((ox,60),"85 x 56 mm | Plaatsingsvoorstel - geen routes",font=font,fill="#172b3a")
    d.rectangle([pt(0,0),pt(85,56)],fill="#133f38",outline="#091e19",width=3)
    if side=="B":
        d.rectangle([pt(12,3),pt(64,33)],outline="#e6c969",width=3)
